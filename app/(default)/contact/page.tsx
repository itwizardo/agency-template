  ...
  const content = {
    nl: {
      ...
      info: {
        ...
        phone: "+31 20 722 3654",
        whatsappContact: "+353 87 769 8056",
              ...
              <div className="bg-gray-900 rounded-xl p-8 text-white">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-gray-400 text-sm mb-1">{t.info.whatsappLabel}</p>
                      <a href={`https://wa.me/${t.info.whatsappContact.replace(/\s/g, '').replace('+', '')}`} target="_blank" rel="noopener noreferrer" className="hover:text-green-400">{t.info.whatsappContact}</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <svg className="w-6 h-6 text-blue-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
